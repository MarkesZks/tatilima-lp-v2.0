...
export const onlineCourses = [
  {
    ...
    content: "O maior organizador de conteúdo para profissionais da área da beleza!\n\n Esse template contém tudo o que você precisa saber para se organizar melhor com seus posts para a divulgação do seu trabalho.\n\n Não ficará sem ideias do que postar, será mais constante e irá ter resultados imediatos! Você terá 2 aulas de como usar o template para sua área do Notion e o acesso é vitalício!",
    image: ImagePlanejamentoLuz,
    buttonText: "Brilhe no seu Instagram!", 
    url: "https://pay.kiwify.com.br/LXD77kM ",
    isImageLeft: true,
  },
  {
